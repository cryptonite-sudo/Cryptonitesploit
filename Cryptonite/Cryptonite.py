...
os.system("printf '\033]2;Cryptonite Toolkit\a'")
...
parser.add_argument("-u","--update",dest='update',help="Update Cryptonite Tool.",action='store_true')
parser.add_argument("--version",dest='version',help="Show Cryptonite Tool version.",action='store_true')

args=parser.parse_args()

if args.update:
    os.system("chmod +x bin/cryptonite && bin/cryptonite -u")
    sys.exit()

if args.version:
    os.system("cat banner/banner.txt")
    print("")
    print("Cryptonite  v1.0")
    sys.exit()
...
class Scrapy(object):
    ...
    def zoomeye(self):
        ...
        try:
            ...
            if args.outputfile:
                logger.error(color.B+'[-]'+color.E+' Taking IP from ZoomEye occured.',e)
            print(color.B+'[-]'+color.E+' Taking IP from ZoomEye occured.',e)
        finally:
            self.s.close()
